  ...
  <div id="a-page">
              ...
              >
                <span className="icp-nav-link-inner">
                  ...
                  <span className="nav-line-2">
                    <span className="icp-nav-flag icp-nav-flag-in icp-nav-flag-lop" />
                    <div>EN</div>
                    <span
    ...
    />
    <title>
      SELLORIA Silicone Digital Watch Shockproof Multi-Functional Automatic
      Black Color Strap Waterproof Digital Sports Watch For Mens Kids Watch For
      Boys, Men Pack Of 1, Water Resistance : Amazon.in: Fashion
    </title>
    <meta
      name="description"
      content="SELLORIA Silicone Digital Watch Shockproof Multi-Functional Automatic Black Color Strap Waterproof Digital Sports Watch For Mens Kids Watch For Boys, Men Pack Of 1, Water Resistance : Amazon.in: Fashion"
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  SELLORIA Silicone Digital Watch Shockproof
                                  Multi-Functional Automatic Black Color Strap
                                  Waterproof Digital Sports Watch For Mens Kids
                                  Watch For Boys, Men Pack Of 1, Water
                                  Resistance{" "}
                                </span>
                              </h1>
                              <div
                            ...
                            >
                              <div className="a-section a-spacing-none aok-align-center aok-relative">
                                <span className="aok-offscreen">
                                  {" "}
                                  ₹169.00 with 89 percent savings{" "}
                                </span>{" "}
                                <span
                                ...
                                >
                                  ...
                                  <span aria-hidden="true">
                                    ...
                                    <span className="a-price-whole">169</span>
                                  </span>
                                </span>
                                <span
                            ...
                            <ul className="a-unordered-list a-vertical a-spacing-small">
                              <li>
                                <span className="a-list-item a-size-base a-color-base">
                                  Dial Diameter: 38MM "Recommended for Customers
                                  Looking for small Dial Sized Watches"
                                </span>
                              </li>
                              <li>
                                <span className="a-list-item a-size-base a-color-base">
                                  Dial Color: Black; Dial Material: Brass; Dial
                                  Shape: Round; Strap Color: black, Strap
                                  Material: Rubber, Strap Width: 22 MM
                                </span>
                              </li>
                              <li>
                                <span className="a-list-item a-size-base a-color-base">
                                  Warranty Type: Warranty Of 6 Months For
                                  Manufacturing Defects Only
                                </span>
                              </li>
                              <li>
                                <span className="a-list-item a-size-base a-color-base">
                                  Dial Color: Multi; Dial Material: silicon;
                                  Dial Shape: Round
                                </span>
                              </li>
                              <li>
                                <span className="a-list-item a-size-base a-color-base">
                                  Band Material Type: Silicone; Case Material
                                  Type: Plastic; Warranty Type: No Warranty;
                                  Dial Color: Green; Bezel Function: No Bezel
                                  Available
                                </span>
                              </li>
                            </ul>
